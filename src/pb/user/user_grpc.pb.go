...
const (
	...
	UserService_GetUser_FullMethodName   = "/grpc_go.UserService/GetUser"
)
...
type UserServiceClient interface {
	...
	GetUser(ctx context.Context, in *Id, opts ...grpc.CallOption) (*GetUsersResponse, error)
}
...
func (c *userServiceClient) GetUser(ctx context.Context, in *Id, opts ...grpc.CallOption) (*GetUsersResponse, error) {
...
type UserServiceServer interface {
	...
	GetUser(context.Context, *Id) (*GetUsersResponse, error)
...
func (UnimplementedUserServiceServer) GetUser(context.Context, *Id) (*GetUsersResponse, error) {
